...
function alertCheck() {
  ...
  var fecha = birthInput.value;
  var aa = fecha.split("-");
  var robertoCarlos = aa[1]+'/'+aa[2]+'/'+aa[0];
  
  var url = "https://api-rest-server.vercel.app/signup?name=" + nameInput.value + "&lastName=" + surnameInput.value + "&dni=" + DNInput.value + "&dob=" + robertoCarlos + "&phone=" + phoneInput.value +"&address=" + adressInput.value + "&city=" + locationInput.value + "&zip=" + zipCodeInput.value + "&email=" + emailInput.value + "&password=" + passwordInput.value;
  elFetch(url);
